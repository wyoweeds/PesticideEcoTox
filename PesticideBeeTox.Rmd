...
```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 9, fig.height = 6, fig.cap = paste0("**Figure 4. Contribution of insecticide active ingredients to honey bee adult acute contact toxicity index applied to corn or soybean *after* crop emergence. 'All Other Insecticides' category includes ", 100-corn.top7prop, "% of the total corn toxicity index, and ", 100-soy.top7prop, "% of the total soybean toxicity index. **")}
