...
```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 9, fig.height = 8, fig.cap = "**Figure 4. Honeybee eco-efficiency index for pesticides applied to corn or soybean *after* crop emergence.**"}
plot_grid(
  ToxIndex.summary.yr %>% 
