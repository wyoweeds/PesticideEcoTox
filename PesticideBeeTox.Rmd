...
corn.h$cropToxIndex.areaPct`% for herbicides, and `r corn.f <- cropType.summary %>% filter(Crop == "Corn" & Type == "Fungicide")
corn.f$cropToxIndex.areaPct`% for fungicides.
* In soybean, insecticides were responsible for `r soy.i <- cropType.summary %>% filter(Crop == "Soybeans" & Type == "Insecticide")
soy.i$cropToxIndex.areaPct`% of the summed $TI{area}$, compared to `r soy.h <- cropType.summary %>% filter(Crop == "Soybeans" & Type == "Herbicide")
soy.h$cropToxIndex.areaPct`% for herbicides, and `r soy.f <- cropType.summary %>% filter(Crop == "Soybeans" & Type == "Fungicide")
soy.f$cropToxIndex.areaPct`% for fungicides.
