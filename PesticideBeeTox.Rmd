...
#          nrow = 2, align = "v")
plot_grid(cornPre.2panel, corn.aigg, soy.aigg,
          ncol = 1, align = "v",
          labels = LETTERS)
```
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 9, fig.height = 9, fig.cap = "**Figure 4. Honeybee eco-efficiency index for pesticides applied to corn or soybean *after* crop emergence.**"}
plot_grid(
  ToxIndex.summary.yr %>% 
