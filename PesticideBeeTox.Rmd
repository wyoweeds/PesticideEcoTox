...
ToxIndex.summary.yr <- AgroTrak.ecotox %>%
  ...
  mutate(EcoEff = Yield.tha / ToxIndex.area)
ToxIndex.summary <- AgroTrak.ecotox %>%
  ...
  mutate(cropToxIndex.vol = sum(ToxIndex.vol),
         ...
         cropEcoEff.Pct = signif(EcoEff / cropEcoEff*100, 2))
...
cropType.summary <- ToxIndex.summary %>% 
  ...
  summarize(cropToxIndex.volPct = sum(cropToxIndex.volPct),
            ...
            cropEcoEff.Pct = sum(cropEcoEff.Pct))
```
...
tisum.area.gg <- ggplot(ToxIndex.summary, 
  ...
  ggtitle("Area-adjusted Toxicity Index")
ecoeffsum.gg <- ggplot(ToxIndex.summary, 
       aes(x = EcoEff, y = Type)) +
  facet_grid(Crop ~ Timing) + 
  geom_bar(stat = "identity",
           aes(fill = Crop)) +
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 8, fig.height = 6, fig.cap = "**Figure 2. Honey bee adult acute contact toxicity index for insecticides and herbicides applied to corn or soybean *before* crop emergence.**"}
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 9, fig.height = 6, fig.cap = "**Figure 3. Honey bee adult acute contact toxicity index for insecticides and herbicides applied to corn or soybean *after* crop emergence.**"}
plot_grid(ToxIndex.plot(crop = "Corn", timing = "POST", excludeType = "Fungicide"),
          ToxIndex.plot(crop = "Soybeans", timing = "POST", excludeType = "Fungicide"),
          nrow = 1)
```


```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 9, fig.height = 6, fig.cap = "**Figure 4. Honeybee eco-efficiency index for pesticides applied to corn or soybean *after* crop emergence.**"}
plot_grid(
  ToxIndex.summary.yr %>% 
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 8, fig.height = 3, fig.cap = "**Figure 8. Contribution of insect pest taxa to the honey bee adult acute contact toxicity index; soybean pesticides applied *after* crop emergence, 1998-2005 compared to 2016-2020.**"}
insectToxIndex.post %>%
  filter(Crop == "Corn" &
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 8, fig.height = 2.5, fig.cap = "**Figure 9. Contribution of insect pest taxa to the honey bee adult acute contact toxicity index; soybean pesticides applied *after* crop emergence, 1998-2005 compared to 2016-2020.**"}
insectToxIndex.post %>%
